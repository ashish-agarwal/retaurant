...
def gconnect():
    ...
    g_client_secrets_file = 'client_secret.json'
...
def fbconnect():
    ...
    fb_client_secrets_file = 'fb_config.json'
    fb_key = json.loads(open(fb_client_secrets_file, 'r').read())
    app_id = fb_key['app_id']
    app_secret = fb_key['app_secret']
